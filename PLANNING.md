...
- [ ] **v1.0.0** - Production-ready release
  ...
  - [ ] Live-page data-refresh UX, "Level A + Tier 0" (2026-09-08 Decisions Log) -
        ...
        indicator, client-updated relative timestamps, and toasts for
        `hx-swap="none"` actions. Also adds a `node_status` SSE event so the
        Nodes and Dashboard pages live-update on agent connect/disconnect
        (see the 2026-09-08 Decisions Log entry). Fixes the 2026-09-08
        open-control-destroyed bug (Known Issues). Targeted pre-1.0.0; next
        active work.
