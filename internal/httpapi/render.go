...
func loadPageTemplates() (map[string]*template.Template, error) {
	pages := []string{"dashboard", "nodes", "inventory", "profiles", "transfers", "engine_inventory", "engine_transfers", "metrics", "audit", "users", "settings", "register_node", "node_registered", "profile_form", "provision_engine", "initiate_transfer", "forbidden", "create_local_account", "account"}
