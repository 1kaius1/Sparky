...
func newTestDashboardAPI(t *testing.T, nodes *fakeNodeLister, profiles *fakeProfileLister, instances *fakeInstanceLister) *API {
	t.Helper()
	...
	api, err := New(svc, breakGlassSvc, newConfiguredFakeBreakGlassStore(), testSessionSecret, nil, nodes, profiles, instances, testLogger())
	if err != nil {
...
func TestHandleDashboard_FullPage(t *testing.T) {
	...
	api := newTestDashboardAPI(t, nodes, &fakeProfileLister{}, instances)
...
func TestHandleDashboard_HXRequest_ReturnsPartialOnly(t *testing.T) {
	api := newTestDashboardAPI(t, &fakeNodeLister{}, &fakeProfileLister{}, &fakeInstanceLister{})
...
func TestHandleDashboard_ListNodesFails(t *testing.T) {
	...
	api := newTestDashboardAPI(t, nodes, &fakeProfileLister{}, &fakeInstanceLister{})
...
func TestHandleModelProfiles_ResolvesTargetNodeName(t *testing.T) {
	...
	api := newTestDashboardAPI(t, nodes, profiles, &fakeInstanceLister{})
...
func TestHandleModelProfiles_ListProfilesFails(t *testing.T) {
	...
	api := newTestDashboardAPI(t, &fakeNodeLister{}, profiles, &fakeInstanceLister{})
