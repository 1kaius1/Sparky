...
func TestCanViewAuditLog(t *testing.T) {
	...
	for _, tt := range tests {
		name := fmt.Sprintf("tier=%s,superadmin=%v", tt.actor.Tier, tt.actor.IsSuperAdmin)
		t.Run(name, func(t *testing.T) {
			got := CanViewAuditLog(tt.actor)
			if got != tt.want {
				t.Errorf("CanViewAuditLog() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestCanViewUsers(t *testing.T) {
	tests := []struct {
		actor Actor
		want  bool
	}{
	...
	for _, tt := range tests {
		name := fmt.Sprintf("tier=%s,superadmin=%v", tt.actor.Tier, tt.actor.IsSuperAdmin)
		t.Run(name, func(t *testing.T) {
			got := CanViewUsers(tt.actor)
			if got != tt.want {
				t.Errorf("CanViewUsers() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestCanManageProfiles(t *testing.T) {
	...
	for _, tt := range tests {
		name := fmt.Sprintf("tier=%s,superadmin=%v", tt.actor.Tier, tt.actor.IsSuperAdmin)
		t.Run(name, func(t *testing.T) {
			got := CanManageProfiles(tt.actor)
			if got != tt.want {
				t.Errorf("CanManageProfiles() = %v, want %v", got, tt.want)
			}
		})
	}
}
